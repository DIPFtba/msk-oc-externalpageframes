...
const ExtResFromSchema = {
	barPlot: { version: "0.3.1" },
	barSlider: { version: "0.3.1" },
	barSliderFull: { version: "0.3.1" },
	chatBotJson: { version: "0.3.1" },
	chatTextAudio: { version: "0.3.1" },
	// vueExamplePropsEmit: { version: "0.3.1" },
	// vueExamplePinia: { version: "0.3.1" },
	connectedFrames: { version: "0.3.1" },
	filledBar: { version: "0.3.1" },
	freePaint: { version: "0.3.1" },
	freePaintMult: { version: "0.3.1" },
	freePaintRecog: { version: "0.3.1" },
	inputfield: { version: "0.3.1" },
	inputGrid: { version: "0.3.1" },
	numberLine: { version: "0.3.1" },
	numberLineWithAnnotations: { version: "0.3.1" },
	numberLineWithArcs: { version: "0.3.1" },
	numbersByPictures: { version: "0.3.1" },
	pikasTextEntry: { version: "0.3.1" },
	pointArea: { version: "0.3.1" },
	pointAreaExt: { version: "0.3.1" },
	ratings: { version: "0.4.1" },
	recordAudio: { version: "0.4.1" },
	rectArrayMarkable: { version: "0.3.1" },
	stampImages: { version: "0.3.1" },
	inputInserts: { version: "0.3.1" },
	textareaInserts: { version: "0.3.1" },
};
