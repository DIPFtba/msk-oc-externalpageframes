...
const ExtResFromSchema = {
	barPlot: { version: "0.3.2" },
	barSlider: { version: "0.3.2" },
	barSliderFull: { version: "0.3.2" },
	chatBotJson: { version: "0.3.2" },
	chatTextAudio: { version: "0.4.0" },
	// vueExamplePropsEmit: { version: "0.3.2" },
	// vueExamplePinia: { version: "0.3.2" },
	connectedFrames: { version: "0.3.2" },
	...
	inputInserts: { version: "0.3.2" },
	numberLine: { version: "0.3.2" },
	numberLineWithAnnotations: { version: "0.3.2" },
	numberLineWithArcs: { version: "0.3.2" },
	numbersByPictures: { version: "0.3.2" },
	pikasTextEntry: { version: "0.3.2" },
	pointArea: { version: "0.3.2" },
	pointAreaExt: { version: "0.3.2" },
	ratings: { version: "0.4.3" },
	recordAudio: { version: "0.4.2" },
	rectArrayMarkable: { version: "0.3.2" },
	stampImages: { version: "0.3.2" },
	textareaInserts: { version: "0.3.2" },
};
